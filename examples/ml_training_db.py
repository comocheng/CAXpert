...
command = f'time python /global/cfs/cdirs/m4126/xuchao/fairchem/main.py --mode train --config-yml ft/config.yml --checkpoint /global/cfs/cdirs/m4126/xuchao/ce_models/co_ni/ocp_train/fine_tuning/checkpoints/2024-06-22-17-21-20-co_ni_cov/best_checkpoint.pt --run-dir ft --identifier co_ni_cov --amp > ft/train.txt 2>&1'
